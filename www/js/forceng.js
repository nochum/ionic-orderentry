...
angular.module('forceng', [])
    ...
    .factory('force', function ($rootScope, $q, $window, $http) {
        ...
        // The Connected App client Id
            appId = '3MVG9KI2HHAq33RyQ0XI.0HmX6RVPKlXmvrVAa08pOmm8Dh.HNc5yAat0vj0p4GvmZSZ_Xhpt9eHx4ZjePHxu',
        ...
        /**
         * Create a parent record with children
         * @param objectName
         * @param data
         * @returns {*}
         */
        function treeSave(objectName, data) {

            return request({
                method: 'POST',
                contentType: 'application/json',
                path: '/services/data/' + apiVersion + '/composite/tree/' + objectName + '/',
                data: data
            });
